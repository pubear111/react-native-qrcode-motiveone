...
class AssetQR1Screen extends React.Component {
...
const mapDispatchToProps = dispatch => ({
    actions: bindActionCreators(Object.assign({}, dispatchActions, returnedActions), dispatch)
})

export default connect(mapStateToProps, mapDispatchToProps)(AssetQR1Screen)